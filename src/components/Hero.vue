...
<template>
    <section id="inicio" class="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6 z-10">
                ...
                <div class="flex flex-wrap gap-4 pt-2">
                    <a href="#proyectos"
                        class="px-6 py-3 bg-primary text-darker font-bold rounded-lg hover:bg-cyan-400 transition-all shadow-[0_0_20px_rgba(56,189,248,0.3)]">
                        Ver Proyectos
                    </a>
                    <a href="/cv.pdf" target="_blank"
                        class="px-6 py-3 border border-slate-700 rounded-lg hover:border-slate-500 hover:bg-slate-800/50 transition-all text-white">
                        Descargar CV
                    </a>
                </div>
                ...
                <div class="pt-8 border-t border-slate-800/50 mt-8">
                    ...
                    <div class="flex gap-6 text-3xl text-slate-400">
                        <i class="devicon-vuejs-plain hover:text-green-400 transition-colors cursor-help"
                            title="Vue.js"></i>
                        <i class="devicon-tailwindcss-original hover:text-cyan-400 transition-colors cursor-help"
                            title="Tailwind CSS"></i>
                        <i class="devicon-flutter-plain hover:text-blue-400 transition-colors cursor-help"
                            title="Flutter"></i>
                        <i class="devicon-typescript-plain hover:text-blue-600 transition-colors cursor-help"
                            title="TypeScript"></i>
                        <i class="devicon-linux-plain hover:text-yellow-500 transition-colors cursor-help"
                            title="Linux User"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="relative hidden md:block group">
                ...
                <div class="relative bg-card border border-slate-700/50 rounded-2xl p-2 overflow-hidden shadow-2xl">
